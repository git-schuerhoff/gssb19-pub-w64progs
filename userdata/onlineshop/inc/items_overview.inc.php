...
$outer = $this->gs_file_get_contents('template/itemsoverview_outer_layout.html');
$line = $this->gs_file_get_contents('template/itemsoverview_line.html');
...
while($z = mysqli_fetch_assoc($erg))
{
	...
	//Add boxes
	$this_line = str_replace('{GSSE_INCL_ITEMSOVERVIEWBOX}',$this_box,$this_line);
