...
$sql = "SELECT itemItemId, itemItemNumber, itemItemDescription, itemSmallImageFile, " .
	 "itemIsNewItem, itemHasDetail, itemItemPage, itemIsCatalogFlg, itemItemText, " .
	 "itemIsVariant, itemAttribute1, itemAttribute2, itemAttribute3, itemIsTextInput, " .
	 "itemInStockQuantity, itemAvailabilityId, itemDetailText1, itemIsTextHasNoPrice, itemShipmentStatus, " .
	 "itemCheckAge, itemMustAge, itemIsAction, itemisDecimal, prcPrice as ItemPrice " .
...
if(mysqli_errno($pgidbh) == 0)
{
	if(mysqli_num_rows($erg) > 0)
	{
		while($z = mysqli_fetch_assoc($erg))
		{
			...
			$aHelper['avail'] = $pgse->get_availability($z['itemInStockQuantity'],$z['itemShipmentStatus'],0);
