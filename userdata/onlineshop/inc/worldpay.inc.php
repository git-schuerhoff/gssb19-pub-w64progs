...
$merchantCode="YourMerchantCode";  // ToDo: in Delphi Zusatzfeld hiterlegen
$password="YourMerchantPassword";  // ToDo: in Delphi Zusatzfeld hiterlegen
$orderCode="example".time();

// Shopper specific details
$shopperEmailAddress = $wp->get_setting('edOrderEmail_Text');//"myemail@demo.com";
$shopperID = $wp->get_setting('edWorldPayID_Text');//"shopper-123456";
$firstName="";
$lastName = $wp->get_setting('edShopContactPerson_Text');//"Doe";
$shopperStreet = $wp->get_setting('edShopStreet_Text');//"11 Hereortherestreet";
$postalCode=$wp->get_setting('edShopZipCode_Text');//"1234 KL";
$shopperCity=$wp->get_setting('edShopCity_Text');//"myCiti";
$shopperTelephone=$wp->get_setting('edShopTelephone_Text');//"00123456789";
$countryCode = "DE";//$wp->get_setting('edShopStreet_Text');//"DE";
