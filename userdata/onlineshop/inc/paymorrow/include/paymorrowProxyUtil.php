<?php
$soapBody = new DOMDocument('1.0', 'UTF-8');
...
function sendRequestToPaymorrow($paymorrowOrderRequest, $authorizationKey) {
   ...
   // History Ends
	...
	$res = sendHTTP($reqBody,$se->get_setting('paymorrowServerURL_Text'),$se->get_setting('paymorrowServerPort_Text'),$se->get_setting('paymorrowServerPfad_Text'));
