...
function preparePaymorrowResponse($res) {
    ...
    try {
        ...
        $orderPaymorrow->orderId = getIfNotNull($paymorrowResp, "orderId");
        $orderPaymorrow->orderTimestamp = getIfNotNull($paymorrowResp, "orderTimestamp");
        $orderPaymorrow->orderShoppingDuration = getIfNotNull($paymorrowResp, "orderShoppingDuration");
        $orderPaymorrow->orderCheckoutDuration = getIfNotNull($paymorrowResp, "orderCheckoutDuration");
        $orderPaymorrow->orderSalesChannelId = getIfNotNull($paymorrowResp, "orderSalesChannelId");

        //Create Customer for the order
        $customerPaymorrow = new CustomerType();
        $customerPaymorrow->customerId = getIfNotNull($paymorrowResp, "customerId");
        $customerPaymorrow->customerGroupId = getIfNotNull($paymorrowResp, "customerGroupId");
        $customerPaymorrow->customerPreferredLanguage = getIfNotNull($paymorrowResp, "customerPreferredLanguage");
        $customerPaymorrow->customerIPAddress = getIfNotNull($paymorrowResp, "customerIPAddress");
        $customerPaymorrow->orderCustomerType = getIfNotNull($paymorrowResp, "orderCustomerType");
        ...
        $customerPaymorrow->customerHistory = $customerHistory;
        // History Ends
        ...
        $orderPaymorrow->orderExpectedDeliveryDate = getIfNotNull($paymorrowResp, "orderExpectedDeliveryDate");
        $orderPaymorrow->orderAmountNet = getIfNotNull($paymorrowResp, "orderAmountNet");
		...
		$orderPaymorrow->orderAmountVATTotal = getIfNotNull($paymorrowResp, "orderAmountVATTotal");

        $orderPaymorrow->orderAmountGross = getIfNotNull($paymorrowResp, "orderAmountGross");
        $orderPaymorrow->orderCurrencyCode = getIfNotNull($paymorrowResp, "orderCurrencyCode");
