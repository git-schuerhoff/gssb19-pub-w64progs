...
class ShopcommentSettings {
	 ...
	 */
	function load() {
		$qry = "SELECT itseVisDef FROM " . DBToken . "itemcomments_settings WHERE itseIdNo = 2";
	 ...
	 */
	function save() {
		$qry = "UPDATE " . DBToken . "itemcomments_settings SET itseVisDef='" . $this->visibilityDefault . "' WHERE itseIdNo=2";
