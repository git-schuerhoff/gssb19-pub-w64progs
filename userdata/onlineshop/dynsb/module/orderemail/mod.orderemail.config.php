...
define("URL_ORDEREMAIL","../module/"."orderemail/");
...
// tree menu captions
$modName_lang = L_dynsb_OrderEmail;
$modName_lang_edit = L_dynsb_Edit;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulOrderEmail;
...
// link
$modLink = "mod.orderemail.run.php";
...
$modTreeStr .= "gsm[".($this->mvStartIndex+1)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."1', '".$modId."', '".$modName_lang_edit."', '".URL_ORDEREMAIL."mod.orderemail.detail.php?act=a&lang=".$lang."');\n";
?>
