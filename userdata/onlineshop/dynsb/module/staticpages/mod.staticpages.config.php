...
define("URL_staticpages","../module/"."staticpages/");
...
// link
$modLink = "mod.staticpages.run.php";
...
$modTreeStr .= "gsm[".($this->mvStartIndex+1)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."2', '".$modId."', '".$modName_lang_import."', '".URL_staticpages."mod.staticpages.search.php?lang=".$lang."');\n";
?>
