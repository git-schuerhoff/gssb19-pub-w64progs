<?php
/******************************************************************************/
/* File: mod.gsmostsellingarticle.show.php                                    */
/******************************************************************************/
...
$SQL = "SELECT op.ordpItemId, SUM(op.ordpQty) AS qty FROM ".DBToken."_orderpos op, ".DBToken."order o
        WHERE
...
$dia->setHText(L_dynsb_MostSellingArticle." / ".L_dynsb_Top." ".count($data), 3, 20 - ($layout * 10), 15, 'gsdarkblue');
