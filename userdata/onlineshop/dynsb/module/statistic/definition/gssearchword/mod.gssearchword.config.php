...
define("URL_GSsearchword",URL_STATISTIC_DEF."gssearchword/");
...
// tree menu captions
$modName_lang = L_dynsb_MostSearchedWord;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulMostSearchedWord;
...
// link
$modLink = URL_GSsearchword."mod.gssearchword.run.php?lang=".$lang;
