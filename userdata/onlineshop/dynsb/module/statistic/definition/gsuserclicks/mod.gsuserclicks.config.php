...
*    @author: Jan Reker
*
*    (c) 2004-2009 GS Software Solutions GmbH
*
*
...
define("URL_gsvuserclicks", URL_STATISTIC_DEF . "gsuserclicks/");
...
// tree menu captions
$modName_lang =  L_dynsb_monuserclickspageimpressions . " / " . L_dynsb_monuserclicksduration;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmoduluserclicks;
...
// link
$modLink = URL_gsvuserclicks."mod.gsuserclicks.run.php?lang=".$lang;
