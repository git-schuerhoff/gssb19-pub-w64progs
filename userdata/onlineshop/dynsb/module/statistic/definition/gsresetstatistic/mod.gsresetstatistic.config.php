...
define("URL_GSresetstatistic",URL_STATISTIC_DEF."gsresetstatistic/");
...
// tree menu captions
$modName_lang = L_dynsb_StatisticReset;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulStatisticReset;
...
// link
$modLink = URL_GSresetstatistic."mod.gsresetstatistic.run.php?lang=".$lang;
