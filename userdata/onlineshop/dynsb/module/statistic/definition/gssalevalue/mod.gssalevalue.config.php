...
define("URL_GSsalevalue",URL_STATISTIC_DEF."gssalevalue/");
...
// tree menu captions
$modName_lang = L_dynsb_VolumeOfSales;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulVolumeOfSales;
...
// link
$modLink = URL_GSsalevalue."mod.gssalevalue.run.php?lang=".$lang;
