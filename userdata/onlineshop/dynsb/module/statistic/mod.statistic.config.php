...
define("URL_STATISTIC","../module/"."statistic/");
define("URL_STATISTIC_DEF",URL_STATISTIC."definition/");
...
// tree menu captions
$modName_lang = L_dynsb_Statistic;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulStatistic;
...
// link
$modLink = "somewhere.php";

// has subModule (0 = No / 1 = Yes)
$modHasSubModule = 1;

// if subModule = 0 then ""
$modSubModuleFolder = URL_STATISTIC_DEF;
