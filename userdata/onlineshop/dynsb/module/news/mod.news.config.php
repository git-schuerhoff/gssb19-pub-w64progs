...
// tree menu captions
$modName_lang = L_dynsb_News;
$modName_lang_add = L_dynsb_Add;
$modName_lang_edit = L_dynsb_Edit;
$modName_lang_ticker = L_dynsb_Newsticker;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulNewsticker;
...
$modTreeStr .= "gsm[".($this->mvStartIndex+1)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."1', '".$modId."', '".$modName_lang_ticker."', '".URL_NEWS."mod.news.ticker.detail.php?act=e&lang=".$lang."');\n";
$modTreeStr .= "gsm[".($this->mvStartIndex+2)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."2', '".$modId."', '".$modName_lang_add."', '".URL_NEWS."mod.news.detail.php?act=a&lang=".$lang."');\n";
$modTreeStr .= "gsm[".($this->mvStartIndex+3)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."3', '".$modId."', '".$modName_lang_edit."', '".URL_NEWS."mod.news.search.php?lang=".$lang."');\n";
?>
