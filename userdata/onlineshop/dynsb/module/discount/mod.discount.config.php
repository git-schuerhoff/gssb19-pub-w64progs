...
define("URL_DISCOUNT","../module/"."discount/");
...
// tree menu captions
$modName_lang = L_dynsb_CustomerDiscount;
$modName_lang_add = L_dynsb_Set;
// caption info for the about-screen
$modCaption_lang = L_dynsb_GSmodulCustomerDiscount;
...
$modTreeStr .= "gsm[".($this->mvStartIndex+1)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."2', '".$modId."', '".$modName_lang_add."', '".URL_DISCOUNT."mod.discount.detail.php?act=a&lang=".$lang."');\n";
?>
