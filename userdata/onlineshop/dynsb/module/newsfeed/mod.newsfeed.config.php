...
define("URL_Newsfeed","../module/"."newsfeed/");
...
// tree menu captions
$modName_lang = L_dynsb_Newsfeed;
#$modName_lang = "Newsfeed_lang";

$modName_lang_import = L_dynsb_Newsfeed_admin;
#$modName_lang_import = "Newsfeed_lang_import";
// caption info for the about-screen
#$modCaption_lang = L_dynsb_GSmodulDataImport;
$modCaption_lang = "Newsfeed_GSmodulNewsfeed";
$modCaption_lang = "GS Software Newsfeed Modul";
...
$modTreeStr .= "gsm[".($this->mvStartIndex+1)."] = new Array(".($this->mvTreeLevel+1).", 1, 'x".$modId."2', '".$modId."', '".$modName_lang_import."', '".URL_Newsfeed."mod.newsfeed.search.php?lang=".$lang."');\n";
?>
